...
class KUNorthCampusCanteen(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        def split_and_store(result: list[str], weekdays: list[str]) -> str:
        ...
        hco_result_json = split_and_store(hco_result, WEEKDAYS)
        bio_result_json = split_and_store(bio_result, WEEKDAYS_DANISH)
